...
- todo列表项编辑部分的ui都重叠了，如图

  ![image-20260211001847805](https://raw.githubusercontent.com/spacehouse/imgForBlog/master/img/image-20260211001847805.png)

- GUI设置界面部分设置项没有描述，不清楚是什么作用，如图

  ![image-20260211002024404](C:/Users/Administrator/AppData/Roaming/Typora/typora-user-images/image-20260211002024404.png)
...
- [ ] 默认高度为120像素（列表高度默认为140）
- [ ] GUI尺寸已更新为350x250（GUI尺寸默认为300x300）
