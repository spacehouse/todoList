...
TodoList is a Minecraft todo mod for single-player, LAN, and multiplayer collaboration across Fabric / Forge / NeoForge. This document describes what is available in v1.3.0 from a user perspective.
...
- Top-right HUD shows tasks for the current view, supports expand/collapse (H key), visibility toggle (J key), and count display
