...
public class ConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        hudWidthField = new EditBox(this.font, leftFieldWidth, fieldHeight, Component.empty());
        hudWidthField.setPosition(leftFieldX, y + row * rowHeight);
        hudWidthField.setValue(Integer.toString(config.getHudWidth()));
        this.addRenderableWidget(hudWidthField);

        hudMaxHeightField = new EditBox(this.font, rightFieldWidth, fieldHeight, Component.empty());
        hudMaxHeightField.setPosition(rightFieldX, y + row * rowHeight);
