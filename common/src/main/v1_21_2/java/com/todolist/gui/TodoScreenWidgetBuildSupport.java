...
final class TodoScreenWidgetBuildSupport {
    ...
    static ContentWidgets buildContentWidgets(Font font,
        ...
        // v1_21_2 覆盖：EditBox/MultiLineEditBox 构造移除 x/y 参数，改用 setPosition 定位
        EditBox searchField = new EditBox(font, searchWidth, secondRowHeight, Component.empty());
        searchField.setPosition(filtersX, secondRowY);
    ...
    static SidebarWidgets buildSidebarWidgets(Minecraft minecraft,
        ...
        EditBox projectSearchField = new EditBox(font, sidebarInnerWidth, searchFieldHeight, Component.translatable("gui.todolist.project.search"));
        projectSearchField.setPosition(sidebarInnerX, projectSearchY);
    ...
    static TaskAreaWidgets buildTaskAndQuickAddWidgets(Minecraft minecraft,
        ...
        EditBox quickAddField = new EditBox(font, quickAddFieldWidth, inputRowHeight, Component.empty());
        quickAddField.setPosition(quickAddFieldX, inputRowY);
    ...
    static DetailWidgets buildDetailWidgets(Font font,
        ...
        EditBox titleField = new EditBox(font, titleFieldWidth, titleFieldHeight, Component.empty());
        titleField.setPosition(assignsX, titleFieldY);
        ...
        EditBox tagField = new EditBox(font, rightFieldWidth, 20, Component.empty());
        tagField.setPosition(assignsX, tagFieldY);
