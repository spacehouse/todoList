...
final class TodoScreenTestAccess {
    ...
    List<String> getProjectSearchPrefixSuggestionTextsForTest() {
        return TodoScreenTestSupport.getProjectSearchPrefixSuggestionTextsForTest();
    }
    ...
    int[] getProjectSearchPrefixSuggestionBoundsForTest(int index) {
        return TodoScreenTestSupport.getProjectSearchPrefixSuggestionBoundsForTest(
                getProjectSearchFieldForTest(),
                index
        );
    }
    ...
    /**
     * 聚焦项目搜索输入框，并触发前缀下拉提示显示逻辑。
     */
    void focusProjectSearchFieldForTest() {
        EditBox field = getProjectSearchFieldForTest();
        TodoScreenTestSupport.focusProjectSearchFieldForTest(
                field,
                () -> screen.setFocused(field),
                invoke(screen, "canUseProjectSearchPrefixDropdown", Boolean.class, new Class<?>[0]),
                () -> invokeVoid(screen, "openProjectSearchPrefixDropdown", new Class<?>[0]),
                () -> invokeVoid(screen, "syncProjectSearchPrefixDropdownState", new Class<?>[0])
        );
    }
    ...
    List<String> getVisibleProjectNamesForTest() {
        return TodoScreenTestSupport.getVisibleProjectNamesForTest(
                readScreenField("projectListWidget", ProjectListWidget.class)
        );
    }
    ...
    List<String> getContextMenuItemTextsForTest() {
        return TodoScreenTestSupport.getContextMenuItemTextsForTest(readScreenListField("contextMenuItems"));
    }
    ...
    List<String> getAssignablePlayerNamesForTest(Screen screen) {
        return TodoScreenTestSupport.getAssignablePlayerNamesForTest(screen);
    }
    ...
    int getAssignPlayerScrollOffsetForTest(Screen screen) {
        return TodoScreenTestSupport.getAssignPlayerScrollOffsetForTest(screen);
    }
    ...
    int getAssignPlayerVisibleRowsForTest(Screen screen) {
        return TodoScreenTestSupport.getAssignPlayerVisibleRowsForTest(screen);
    }
    ...
    void scrollAssignPlayerListForTest(Screen screen, int steps) {
        TodoScreenTestSupport.scrollAssignPlayerListForTest(screen, steps);
    }
    ...
    void setAssignPlayerSearchForTest(Screen screen, String value) {
        TodoScreenTestSupport.setAssignPlayerSearchForTest(screen, value);
    }
    ...
    void clickAssignPlayerRowForTest(Screen screen, int rowIndex) {
        TodoScreenTestSupport.clickAssignPlayerRowForTest(screen, rowIndex);
    }
